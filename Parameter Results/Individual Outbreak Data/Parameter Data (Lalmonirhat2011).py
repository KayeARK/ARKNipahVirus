...
plt.savefig('Lalmonirhat2011ParameterValuesAfterEachIterationofABC.pdf',bbox_inches='tight',transparent = True)
plt.show()
...
plt.savefig('Lalmonirhat2011PriorandPosteriorafter15IterationsofABCforEachParameter.pdf',bbox_inches='tight',transparent = True)
plt.show()
